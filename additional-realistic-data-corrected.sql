-- Additional Test Data for Existing Database Structure (Corrected)
...
(41, 9, 'CHECKOUT_CLEANING', 'IN_PROGRESS', 'NORMAL', 'Standard budget room cleaning', 'Tourist guest, standard protocol', '2025-08-26 09:00:00', '2025-08-26 09:30:00', '2025-08-26 10:00:00', NULL, 40, NULL, NULL, NULL, 'budget-stays'),

(42, 10, 'DEEP_CLEANING', 'COMPLETED', 'NORMAL', 'Lobby and corridor cleaning', 'High traffic area maintenance', '2025-08-26 06:00:00', '2025-08-26 06:30:00', '2025-08-26 07:00:00', '2025-08-26 08:30:00', 120, 90, 4, 'Public areas cleaned efficiently', 'budget-stays'),

-- Boutique hotel specialized tasks
(50, 11, 'MAINTENANCE_CLEANING', 'COMPLETED', 'HIGH', 'Art preservation cleaning', 'Careful cleaning around valuable artwork', '2025-08-26 08:00:00', '2025-08-26 08:30:00', '2025-08-26 09:00:00', '2025-08-26 10:15:00', 40, 75, 5, 'Exceptional care with artistic elements', 'boutique-collection'),

(51, 12, 'CHECKOUT_CLEANING', 'IN_PROGRESS', 'HIGH', 'Creative workspace setup cleaning', 'Clean and arrange studio space for artist guest', '2025-08-26 10:00:00', '2025-08-26 10:30:00', '2025-08-26 11:00:00', NULL, 30, NULL, NULL, NULL, 'boutique-collection');
