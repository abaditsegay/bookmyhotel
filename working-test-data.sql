-- Final Working Test Data for Existing Database Structure
...
-- =============================================
-- ADDITIONAL REALISTIC RESERVATIONS (using existing room IDs and required fields)
-- =============================================
...
-- Today's check-ins
('d7b7e673-6788-45b2-8dad-4d48944a144e', 3, 11, '2025-08-26', '2025-08-30', 1296.00, 'CHECKED_IN', 'Late check-in, champagne welcome', 'HTL-2025-TODAY-001', 'Lisa Chen', 'lisa.chen@email.com', '+1-555-0101', 2, '2025-08-20 14:30:00', '2025-08-26 15:00:00'),

('ed55191d-36e0-4cd4-8b53-0aa6306b802b', 10, 12, '2025-08-26', '2025-08-28', 178.00, 'CHECKED_IN', 'Business traveler, quiet room', 'HTL-2025-TODAY-002', 'James Wilson', 'james.wilson@email.com', '+1-555-0102', 1, '2025-08-24 16:20:00', '2025-08-26 14:00:00'),

-- Tomorrow's arrivals
('d7b7e673-6788-45b2-8dad-4d48944a144e', 4, 10, '2025-08-27', '2025-08-29', 698.00, 'CONFIRMED', 'Anniversary celebration', 'HTL-2025-TOM-001', 'Maria Rodriguez', 'maria.rodriguez@email.com', '+1-555-0103', 2, '2025-08-25 09:15:00', '2025-08-25 09:15:00'),

('ed55191d-36e0-4cd4-8b53-0aa6306b802b', 11, 9, '2025-08-27', '2025-08-30', 267.00, 'CONFIRMED', 'Tourist, subway directions needed', 'HTL-2025-TOM-002', 'David Brown', 'david.brown@email.com', '+1-555-0104', 1, '2025-08-26 12:10:00', '2025-08-26 12:10:00');
