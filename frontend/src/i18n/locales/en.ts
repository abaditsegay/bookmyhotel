export const enTranslations = {
  ...
  dashboard: {
    ...
    housekeepingDashboard: {
      ...
      pending: "Pending",
      allTasks: "All Tasks",
      tasksCount: "({{filtered}} of {{total}} tasks)",
      addTask: "Add Task",
      manageStaff: "Manage Staff",
      refresh: "Refresh",
      filters: "Filters:",
      assignedTo: "Assigned To",
      allTasksFilter: "All Tasks",
      unassigned: "Unassigned",
      status: "Status",
      allStatus: "All Status",
      clearFilters: "Clear Filters",
      showingMyTasks: "Showing only tasks assigned to you",
      noTasksAssigned: "No tasks assigned to you at the moment.",
      noTasksAvailable: "No tasks available.",
      noTasksMatchFilter: "No tasks match the current filters.",
      // Table headers
      title: "Title",
      type: "Type",
      room: "Room",
      ...
      // Mobile card labels
      dueLabel: "Due: {{date}}",
      assignedToLabel: "Assigned to: {{name}}",
      // Status update dialog
      taskDetails: "Task Details",
      updateTaskStatus: "Update Task Status",
      taskDetailsAndStatus: "Task Details & Status",
      roomNumber: "Room Number",
      taskType: "Task Type",
      currentStatus: "Current Status",
      additionalInfo: "Additional Information",
      description: "Description",
      updateYourProgress: "Update Your Task Progress",
      updateTaskStatusLabel: "Update Task Status",
      changeStatusTo: "Change Status To",
      markAsPending: "Mark as Pending",
      markAsAssigned: "Mark as Assigned",
      markAsInProgress: "Mark as In Progress",
      markAsCompleted: "Mark as Completed",
      cancelTask: "Cancel Task",
      notesOptional: "Notes (optional)",
      notesPlaceholderStaff: "Add any notes about your progress or issues encountered...",
      notesPlaceholderAdmin: "Add notes about this task...",
      notes: "Notes",
      close: "Close",
      cancel: "Cancel",
      ...
      // Create task dialog
      createNewTask: "Create New Housekeeping Task",
      basicInfo: "Basic Information",
      taskTitle: "Task Title",
      taskTitlePlaceholder: "Enter a clear, descriptive title for the task",
      descriptionLabel: "Description",
      descriptionPlaceholder: "Provide detailed description of what needs to be done",
      ...
      roomNumberPlaceholder: "e.g., 101, 205",
      ...
      additionalNotesPlaceholder: "Add any special instructions or requirements",
      createTask: "Create Task",
      // Assignment dialog
      assignTaskToStaff: "Assign Task to Staff Member",
      ...
      // Add staff dialog
      addStaffMember: "Add Housekeeping Staff Member",
      ...
      failedToLoadStaff: "Failed to load staff members",
      failedToAssignTask: "Failed to assign task",
      failedToCreateStaff: "Failed to create staff member",
