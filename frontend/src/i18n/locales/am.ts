export const amTranslations = {
  ...
  dashboard: {
    ...
    housekeepingDashboard: {
      myTasks: "የእኔ ተግባራት",
      tasksOverview: "የተግባራት ማጠቃለያ",
      totalTasks: "ጠቅላላ ተግባራት",
      completed: "የተጠናቀቁ",
      inProgress: "በሂደት ላይ",
      pending: "በመጠባበቅ ላይ",
      allTasks: "ሁሉም ተግባራት",
      tasksCount: "({{filtered}} ከ {{total}} ተግባራት)",
      addTask: "ተግባር ጨምር",
      manageStaff: "ሰራተኞችን አስተዳድር",
      refresh: "አድስ",
      filters: "ማጣሪያዎች:",
      assignedTo: "የተመደበለት",
      allTasksFilter: "ሁሉም ተግባራት",
      unassigned: "ያልተመደበ",
      status: "ሁኔታ",
      allStatus: "ሁሉም ሁኔታ",
      clearFilters: "ማጣሪያ አጽዳ",
      showingMyTasks: "ለእርስዎ የተመደቡ ተግባራት ብቻ እያሳየ ነው",
      noTasksAssigned: "በዚህ ​​ጊዜ ለእርስዎ የተመደቡ ተግባራት የሉም።",
      noTasksAvailable: "ተግባራት የሉም።",
      noTasksMatchFilter: "ከአሁኑ ማጣሪያዎች ጋር የሚዛመዱ ተግባራት የሉም።",
      title: "ርዕስ",
      type: "ዓይነት",
      room: "ክፍል",
      priority: "ቅድሚያ",
      ...
      dueLabel: "የመጨረሻ ቀን: {{date}}",
      assignedToLabel: "የተመደበለት: {{name}}",
      taskDetails: "የተግባር ዝርዝር",
      updateTaskStatus: "የተግባር ሁኔታ አዘምን",
      taskDetailsAndStatus: "የተግባር ዝርዝር እና ሁኔታ",
      roomNumber: "ክፍል ቁጥር",
      taskType: "የተግባር ዓይነት",
      currentStatus: "አሁናዊ ሁኔታ",
      additionalInfo: "ተጨማሪ መረጃ",
      description: "መግለጫ",
      updateYourProgress: "የተግባርዎን ሂደት ያዘምኑ",
      updateTaskStatusLabel: "የተግባር ሁኔታ አዘምን",
      changeStatusTo: "ሁኔታ ቀይር ወደ",
      markAsPending: "በመጠባበቅ ላይ ምልክት አድርግ",
      markAsAssigned: "እንደተመደበ ምልክት አድርግ",
      markAsInProgress: "በሂደት ላይ ምልክት አድርግ",
      markAsCompleted: "እንደተጠናቀቀ ምልክት አድርግ",
      cancelTask: "ተግባር ሰርዝ",
      notesOptional: "ማስታወሻዎች (አማራጭ)",
      notesPlaceholderStaff: "ስለ ሂደትዎ ወይም ስለተከሰቱ ችግሮች ማስታወሻ ይጣፍ...",
      notesPlaceholderAdmin: "ስለዚህ ተግባር ማስታወሻ ይጣፍ...",
      notes: "ማስታወሻዎች",
      close: "ዝጋ",
      cancel: "ሰርዝ",
      startTask: "ተግባር ጀምር",
      completeTask: "ተግባር ጨርስ",
      markComplete: "ጨርስ",
      createNewTask: "አዲስ የጽዳት ተግባር ፍጠር",
      basicInfo: "መሰረታዊ መረጃ",
      taskTitle: "የተግባር ርዕስ",
      taskTitlePlaceholder: "ለተግባሩ ግልጽ እና ገላጭ ርዕስ ያስገቡ",
      descriptionLabel: "መግለጫ",
      descriptionPlaceholder: "ምን መደረግ እንዳለበት ዝርዝር መግለጫ ይስጡ",
      taskClassification: "የተግባር ምድብ",
      taskTypeLabel: "የተግባር ዓይነት",
      priorityLabel: "ቅድሚያ",
      roomCleaning: "ክፍል ማጽዳት",
      deepCleaning: "ጥልቅ ጽዳት",
      laundry: "ልብስ ማጠቢያ",
      publicAreaCleaning: "የህዝብ ቦታ ጽዳት",
      inventoryCheck: "የዕቃ ክምችት ምርመራ",
      maintenanceRequest: "የጥገና ጥያቄ",
      low: "ዝቅተኛ",
      normal: "መደበኛ",
      high: "ከፍተኛ",
      urgent: "አስቸኳይ",
      ...
      roomNumberLabel: "ክፍል ቁጥር",
      roomNumberPlaceholder: "ለምሳሌ 101፣ 205",
      floorNumber: "ፎቅ ቁጥር",
      optional: "አማራጭ",
      scheduling: "መርሐ ግብር",
      estimatedDuration: "ግምታዊ ጊዜ (ደቂቃ)",
      dueDateTime: "የመጨረሻ ቀን እና ሰዓት",
      additionalNotes: "ተጨማሪ ማስታወሻዎች",
      additionalNotesPlaceholder: "ልዩ መመሪያዎች ወይም መስፈርቶችን ያክሉ",
      createTask: "ተግባር ፍጠር",
      assignTaskToStaff: "ተግባር ለሰራተኛ መድብ",
      selectStaffMember: "ሰራተኛ ይምረጡ",
      staffMember: "ሰራተኛ",
      noStaffAvailable: "ምንም ሰራተኞች የሉም",
      createNewStaffMember: "አዲስ ሰራተኛ ፍጠር",
      addStaffMember: "የጽዳት ሰራተኛ ጨምር",
      contactInfo: "የመገኛ መረጃ",
      email: "ኢሜል",
      phoneNumber: "ስልክ ቁጥር",
      personalDetails: "የግል ዝርዝር",
      firstName: "ስም",
      lastName: "የአባት ስም",
      employmentDetails: "የስራ ዝርዝር",
      employeeId: "የሰራተኛ መታወቂያ",
      shiftType: "የፈረቃ ዓይነት",
      dayShift: "የቀን ፈረቃ",
      nightShift: "የሌሊት ፈረቃ",
      rotatingShift: "ተለዋጭ ፈረቃ",
      createStaffMember: "ሰራተኛ ፍጠር",
      statusPending: "በመጠባበቅ ላይ",
      statusAssigned: "የተመደበ",
      statusInProgress: "በሂደት ላይ",
      statusCompleted: "የተጠናቀቀ",
      statusOnHold: "በእገዳ ላይ",
      statusCancelled: "የተሰረዘ",
      failedToLoadTasks: "ተግባራትን መጫን አልተሳካም",
      failedToUpdateStatus: "የተግባር ሁኔታ ማዘመን አልተሳካም",
      failedToLoadStaff: "የሠራተኞች ዝርዝር መጫን አልተሳካም",
      failedToAssignTask: "ተግባር መመደብ አልተሳካም",
      failedToCreateStaff: "ሠራተኛ መፍጠር አልተሳካም",
      failedToCreateTask: "ተግባር መፍጠር አልተሳካም",
      emailRequired: "ኢሜይል ያስፈልጋል",
      firstNameRequired: "የመጀመሪያ ስም ያስፈልጋል",
      lastNameRequired: "የአያት ስም ያስፈልጋል",
      employeeIdRequired: "የሠራተኛ መታወቂያ ያስፈልጋል",
      taskTitleRequired: "የተግባር ርዕስ ያስፈልጋል",
      taskDescriptionRequired: "የተግባር መግለጫ ያስፈልጋል",
      dueDateRequired: "የመጨረሻ ቀን ያስፈልጋል",
      roomNumberRequired: "ክፍል ቁጥር ያስፈልጋል",
    }
  },
  ...
  landing: {
    ...
    partner: {
      title: "ከእኛ ጋር ይተባበሩ",
      description: "ንግድዎን ለማሳደግ የሚፈልግ ሆቴል ነዎት? ብዙ ደንበኞችን ለማግኘት፣ ቦታ ማስያዝን በዲጂታል ለማስተዳደር እና ገቢዎን ለማሳደግ መድረካችንን ይቀላቀሉ።",
      registerButton: "ንግድዎን ያስመዝግቡ"
    },
    contact: {
      title: "ያግኙን",
