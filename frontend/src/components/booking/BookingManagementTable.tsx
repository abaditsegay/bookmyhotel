                          ...
                          <Tooltip key={action} title={label} arrow>
                            <IconButton
                              ...
                              sx={{
                                ...
                                padding: '3px',
                                '&:hover': {
                                  backgroundColor: alpha(muiTheme.palette[color].main, 0.12),
                                  transform: 'scale(1.1)'
                                }
                              }}
                            >
                              ...
                              {(booking.status.toUpperCase() === 'CHECKED_IN') && (
                                <Tooltip title={t('booking.management.actions.checkOut')} arrow>
                                  <IconButton 
                                    ...
                                    sx={{
                                      backgroundColor: alpha(muiTheme.palette.warning.main, 0.15),
                                      color: muiTheme.palette.warning.main,
                                      '&:hover': {
                                        backgroundColor: alpha(muiTheme.palette.warning.main, 0.25),
                                        transform: 'scale(1.1)'
                                      },
                                      transition: 'all 0.2s ease'
                                    }}
