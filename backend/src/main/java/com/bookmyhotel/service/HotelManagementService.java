...
public class HotelManagementService {
    ...
    public HotelDTO assignHotelAdmin(Long hotelId, Long userId) {
        ...
        // User will access tenant through hotel relationship
    ...
    /**
     * Get hotels by tenant for dropdown selection (for admin operations)
     */
    ...
    /**
     * Get hotel by ID for hotel staff operations
     */
    public HotelDTO getHotelForStaff(Long hotelId) {
        Hotel hotel = hotelRepository.findByIdAndIsActiveTrue(hotelId)
                .orElseThrow(() -> new RuntimeException("Hotel not found or inactive with ID: " + hotelId));
        return convertToDTO(hotel);
    }

    /**
     * Get basic hotel info for dropdown (single hotel context)
     */
    public HotelDTO getHotelBasicInfo(Long hotelId) {
        Hotel hotel = hotelRepository.findByIdAndIsActiveTrue(hotelId)
