...
public class MaintenanceTask {
    ...
    private User assignedTo; // Maintenance staff
    ...
    private String location; // Specific location description (e.g., "Room 101 bathroom", "Main lobby elevator")
    ...
    public boolean isAssigned() {
        return assignedTo != null && status != TaskStatus.PENDING;
    }
