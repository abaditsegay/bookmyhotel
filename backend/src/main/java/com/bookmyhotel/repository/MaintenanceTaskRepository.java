...
public interface MaintenanceTaskRepository extends JpaRepository<MaintenanceTask, Long> {
    ...
    List<MaintenanceTask> findByTenantIdAndAssignedTo(String tenantId, User assignedTo);
    List<MaintenanceTask> findByTenantIdAndAssignedToOrderByScheduledStartTimeAsc(
        String tenantId, User assignedTo);
    ...
    List<MaintenanceTask> findByTenantIdAndAssignedToAndStatusOrderByScheduledStartTimeAsc(
        String tenantId, User assignedTo, TaskStatus status);
    ...
    // Find by date range
    List<MaintenanceTask> findByTenantIdAndCreatedAtBetween(String tenantId, LocalDateTime start, LocalDateTime end);
    ...
    // For completed tasks in date range - use actualEndTime instead of non-existent completedAt
    ...
    List<Object[]> findStaffWorkloadStats(@Param("tenantId") String tenantId, @Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
