...
public interface PricingStrategyRepository extends JpaRepository<PricingStrategy, Long> {
        ...
        */
       List<PricingStrategy> findByHotelIdAndRoomTypeAndIsActiveTrueOrderByPriorityDesc(Long hotelId,
                     RoomType roomType);

       /**
        * Find active pricing strategies for a hotel that are effective on a specific
        * date
        */
