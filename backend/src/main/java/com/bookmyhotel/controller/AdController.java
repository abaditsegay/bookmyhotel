...
public class AdController {
    ...
    public ResponseEntity<List<AdResponse>> getRandomActiveAds(
            @Parameter(description = "Number of ads to return", example = "5")
    ...
    public ResponseEntity<AdResponse> createAd(
            @Parameter(description = "Ad creation request", required = true)
    ...
    public ResponseEntity<AdResponse> updateAd(
            @Parameter(description = "Ad ID", required = true)
            @PathVariable Long id,
            @Parameter(description = "Ad update request", required = true)
            @Valid @RequestBody AdRequest request) {
