...
public class TodoController {
     ...
     */
    @GetMapping
    @PreAuthorize("hasRole('ADMIN') or hasRole('HOTEL_ADMIN') or hasRole('HOTEL_MANAGER') or hasRole('FRONTDESK') or hasRole('HOUSEKEEPING') or hasRole('OPERATIONS_SUPERVISOR')")
