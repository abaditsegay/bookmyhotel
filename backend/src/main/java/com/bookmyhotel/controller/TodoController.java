...
public class TodoController {
     ...
     */
    @GetMapping
    @PreAuthorize("hasRole('SYSTEM_ADMIN') or hasRole('ADMIN') or hasRole('HOTEL_ADMIN') or hasRole('HOTEL_MANAGER') or hasRole('FRONTDESK') or hasRole('HOUSEKEEPING') or hasRole('OPERATIONS_SUPERVISOR') or hasRole('MAINTENANCE')")
